...
export const metadata: Metadata = {
  ...
  openGraph: { title: "BUBBLE BOOM!", description: "친구와 바로 온라인 대전", images: ["/og.png"] },
  twitter: { card: "summary_large_image", title: "BUBBLE BOOM!", description: "친구와 바로 온라인 대전", images: ["/og.png"] },
};

...
test("camera interpolation is monotonic and exactly reaches the approved tile", () => {
...
test("a new target continues from the current visual position and respawn teleports", () => {
  const camera = new CameraRuntime(100);
  camera.setTarget(0, 0, 0, { teleport: true });
  camera.setTarget(1, 0, 0);
